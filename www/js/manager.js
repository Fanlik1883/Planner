...
class FileManager {
    ...
    getIconPath(extension) {
        const iconMap = {
            "aac": "aac.png", "c": "c.png", "doc": "doc.png", "flv": "flv.png", "iso": "iso.png", "mid": "mid.png",
            "odt": "odt.png", "php": "php.png", "rar": "rar.png", "tga": "tga.png", "xlsx": "xlsx.png", "aiff": "aiff.png",
            "cpp": "cpp.png", "dotx": "dotx.png", "gif": "gif.png", "java": "java.png", "mp3": "mp3.png", "otp": "otp.png",
            "png": "png.png", "rb": "rb.png", "tgz": "tgz.png", "xml": "xml.png", "ai": "ai.png", "css": "css.png",
            "dwg": "dwg.png", "h": "h.png", "hpp": "hpp.png", "js": "js.png", "mp4": "mp4.png", "ott": "ott.png",
            "psd": "psd.png", "sass": "sass.png", "sql": "sql.png", "bmp": "bmp.png", "dmg": "dmg.png", "exe": "exe.png",
            "ics": "ics.png", "less": "less.png", "ods": "ods.png", "pdf": "pdf.png", "qt": "qt.png", "txt": "txt.png",
            "wav": "wav.png", "zip": "zip.png"
        };
        ...
        setTimeout(() => {
            fileTransfer.download(
                ...
                (error) => {
                    let message;
                    switch (error.code) {
                        case 1: message = 'Файл не найден'; break;
                        case 2: message = 'Недопустимый URL'; break;
                        case 3: message = 'Ошибка подключения'; break;
                        case 4: message = 'Отмена операции'; break;
                        case 5: message = 'Файл не был изменен'; break;
                        default: message = 'Нет соответствия кода ошибки';
                    }
